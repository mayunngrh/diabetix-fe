package com.example.diabetix.presentation.new_password
...
fun NewPasswordScreen(
    ...
    Column(
        ...
        HintPasswordField(hint = "Password Baru", onValueChange = {pass = it}, value = pass)
        Spacer(modifier = Modifier.height(24.dp))
        HintPasswordField(hint = "Konfirmasi Password Baru", onValueChange = {confPass = it}, value = confPass)
